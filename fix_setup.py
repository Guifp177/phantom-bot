...
# Salva os arquivos com codificação ANSI (cp1252) que o CMD ama
with open("setup.bat", "w", encoding="cp1252", newline="\r\n") as f:
    f.write(setup_content)

with open("run.bat", "w", encoding="cp1252", newline="\r\n") as f:
    f.write(run_content)

print("[OK] Arquivos setup.bat e run.bat foram reparados com sucesso!")
print("Agora voce pode rodar o setup.bat sem erros de letras sumindo.")
